                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="card mb-4">
                        <form class="card-body" action="/save_publisher" method="POST">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label class="form-label" for="publisherName">إسم الناشر</label>
                                    <input name="publisherName" type="text" id="publisherName" class="form-control" placeholder="" />
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label" for="publisherPhone">رقم الهاتف</label>
                                    <div class="input-group input-group-merge">
                                        <input  name="publisherPhone" type="number" id="publisherPhone" class="form-control" placeholder="" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label" for="publisherEmail">البريد الإلكتروني</label>
                                    <div class="input-group input-group-merge">
                                        <input  name="publisherEmail" type="email" id="publisherEmail" class="form-control" placeholder="" aria-label="john.doe" aria-describedby="multicol-email2" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label" for="publisherCountry">بلد الناشر</label>
                                    <div class="input-group input-group-merge">
                                        <input  name="publisherCountry" type="text" id="multicol-email" class="form-control"  />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label" for="publisherImage">صورة الناشر</label>
                                    <div class="input-group input-group-merge">
                                        <input  name="publisherImage"type="file" id="publisherImage" class="form-control"/>
                                    </div>
                                </div>
