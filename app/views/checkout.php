...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="assets/clientPagesAssets/css/checkout.css" />
  ...
  <section class="container">
      ...
      <div class="checkout-inputs">
        ...
        <section class="done checkout-step hide">
          ...
          <!-- <img src="assets/clientPagesAssets/imgs/svg/" alt=""> -->
        </section>
      </div>
      ...
      <div class="progress_btns">
        <button onclick="handlePrevStep()">
          <img
            src="assets/clientPagesAssets/imgs/svg/rightArrowBlack.svg"
            style="transform: rotateY(180deg)"
            alt=""
          />السابق
        </button>
        <button onclick="handleNextStep()">
          التالي<img src="assets/clientPagesAssets/imgs/svg/rightArrowBlack (2).svg" alt="" />
        </button>
      </div>
    </section>
    ...
    <script src="assets/clientPagesAssets/Js/checkout.js"></script>
