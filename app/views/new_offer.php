      ...
      <g id="Icon" transform="translate(27.000000, 15.000000)">
        ...
        <g id="Triangle" transform="translate(19.000000, 11.000000) rotate(-300.000000) translate(-19.000000, -11.000000) ">
          ...
          <use fill-opacity="0.2" fill="#FFFFFF" xlink:href="#path-5"></use>
                    ...
                    <span class="app-brand-text demo menu-text fw-bolder ms-2">elib</span>
                </a>
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Admin/</span>Add Offer</h4>
                    ...
                    <div class="card mb-4">
                        <h5 class="card-header">Insert Offer Data</h5>
                        <form class="card-body" action="/save_user" method="POST">
                            <h6>1. Offer Details</h6>
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label class="form-label" for="offerTitle">Offer Title</label>
                                    <input name="offerTitle" type="text" id="offerTitle" class="form-control" placeholder="offer title" />
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label" for="offerDiscount">Discount</label>
                                    <div class="input-group input-group-merge">
                                        <input  name="offerDiscount" type="number" id="offerDiscount" class="form-control"  aria-label="john.doe" aria-describedby="multicol-email2" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label" for="offerStartDate">Start Date</label>
                                    <div class="input-group input-group-merge">
                                        <input  name="offerStartDate" type="date" id="offerStartDate" class="form-control"   aria-describedby="multicol-email2" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label" for="offerEndDate">End Date</label>
                                    <div class="input-group input-group-merge">
                                        <input  name="offerEndDate" type="date" id="offerEndDate" class="form-control"   aria-describedby="multicol-email2" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label" for="offerEndDate">End Date</label>
                                ...
                                <div class="col-md-6">
                                    <label for="bookIds">
                                        Select Books ID To Add To This Offer
                                        <select name="bookIds" class="form-control" id="bookIds" multiple>
                                            <option value="">dummy id 1</option>
                                            <option value="">dummy id 2</option>
                                            <option value="">dummy id 3</option>
                                            <option value="">dummy id 3</option>
                                        </select>
                                    </label>
                                </div>
                                <div class="col-md-6">
                                    <label for="categoryIds">
                                        Select Categories ID To Add To This Offer
                                        <select name="categoryIds" class="form-control" id="categoryIds" multiple>
                                            <option value="">dummy id 1</option>
                                            <option value="">dummy id 2</option>
                                            <option value="">dummy id 3</option>
                                        </select>
